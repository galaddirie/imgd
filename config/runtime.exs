...
#
#     PHX_SERVER=true bin/imgd start
#
...
if config_env() == :prod do
  ...
  config :imgd, :dns_cluster_query, System.get_env("DNS_CLUSTER_QUERY")
  ...
  config :imgd, ImgdWeb.Endpoint,
    ...
    cache_static_manifest_latest: PhoenixVite.cache_static_manifest_latest(:imgd)
